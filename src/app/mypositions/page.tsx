...
export default function MyPositions() {
  ...
  const [ekuboPositions, setEkuboPositions] = useState<EkuboPosition[] | undefined>(undefined);
  const [vesuPositions, setVesuPositions] = useState<VesuPosition[] | undefined>(undefined);
