...
export default function HaikoCalculator() {
    ...
    const feeOptions = [
        ...
        { rate: 0.25, precision: 0.5, label: '0.25% fee and 0.5% precision' },
                            ...
                            <div className="p-8 space-y-8">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="space-y-1">
                                        <h1 className="text-2xl font-light">Haiko Protocol Calculator</h1>
