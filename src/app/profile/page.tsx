            ...
            <div className="min-h-screen flex flex-col relative">
                ...
                <main className="flex-1 flex items-center justify-center">
                    <div className="text-center p-6 backdrop-blur-sm">
                        <p className="text-2xl font-neuethin mb-6">Please log in to view your profile.</p>
                        <Link href="/" className="custom-button mt-4 hover:scale-105 transition-transform">
                            Go to Home
                        </Link>
                    </div>
                </main>
    ...
    return (
        <div className="min-h-screen flex flex-col relative">
                    ...
                    <div className="space-y-8">
                        ...
                        {loading ? (
                            <div className="flex justify-center items-center h-64">
                                <div className="text-2xl font-neuethin animate-pulse">Loading...</div>
                            </div>
                        ) : (
                            <div className="space-y-8">
                                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8">
                                    <div className="flex flex-col md:flex-row items-center gap-8">
                                        <div className="relative w-32 h-32 rounded-full overflow-hidden ring-4 ring-white">
                                            <Image
                                                src={user.pfp || '/images/default-avatar.png'}
                                                alt="Profile picture"
                                                fill
                                ...
                                <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8">
                                    ...
                                    <div className="space-y-6">
                                        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 p-4 rounded-lg bg-white/5">
                                            <div>
                                                <p className="text-gray-400 text-sm tracking-wider">Current Plan</p>
                                                <p className="text-2xl font-neuethin">{userDetails?.user_type || 'FREE'}</p>
                                            </div>
                                        ...
                                        <div className="p-4 rounded-lg bg-white/5">
                                            <p className="text-gray-400 text-sm tracking-wider">Next Payment Date</p>
                                            <p className="text-xl font-neuethin">
                                                {userDetails?.plan_exp_date
                                                    ? new Date(userDetails.plan_exp_date).toLocaleDateString()
            ...
            <InfoModal
                ...
                message={'Tier upgrade is not implemented yet, if you want to become a PRO user on Lumos please contact lumosapplication@gmail.com or leave a message on our discord server.'}
            />
            <Footer />
        </div>
    );
