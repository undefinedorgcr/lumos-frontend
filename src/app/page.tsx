  ...
  return (
    <div className="min-h-screen flex flex-col">
        ...
        <div className="max-w-7xl mx-auto w-full">
          <div className="flex flex-col items-center text-center">
            ...
            <div className="max-w-3xl">
              <h1 className="text-4xl lg:text-5xl font-neuethin mb-8">Making DeFi Simple</h1>
              <div className="text-xl lg:text-2xl font-neuethin mb-10">
                <p>
                  Maximize your CLMM yields with intelligent position optimization
                </p>
              </div>
              <div className="flex flex-wrap justify-center gap-6 mb-10">
                {(user === undefined || userDetails?.user_type === "FREE" || userDetails?.user_type !== "FREE") &&
                  <Link
                    href="/calculators"
      ...
      <section className="py-16 px-6 border-t border-gray-800">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl font-neuethin mb-12 text-center">Why choose Lumos for CLMM management?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="p-6 border border-gray-800 rounded-lg">
              ...
              <h3 className="text-xl font-neuethin mb-3">Optimal Position Sizing</h3>
              <p className="font-neuethin">Advanced algorithms determine ideal position sizes based on market conditions and price volatility.</p>
            </div>
            <div className="p-6 border border-gray-800 rounded-lg">
              <div className="w-12 h-12 flex items-center justify-center rounded-full border border-gray-700 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <h3 className="text-xl font-neuethin mb-3">Real-time Rebalancing</h3>
              <p className="font-neuethin">Stay in optimal range with automated position rebalancing as market conditions change.</p>
            </div>
            <div className="p-6 border border-gray-800 rounded-lg">
              <div className="w-12 h-12 flex items-center justify-center rounded-full border border-gray-700 mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2vquot10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <h3 className="text-xl font-neuethin mb-3">Performance Analytics</h3>
              <p className="font-neuethin">Comprehensive data visualizations and performance metrics to maximize your returns.</p>
            </div>
          </div>
        </div>
      </section>
      <section className="py-16 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-neuethin mb-6">Ready to transform your DeFi liquidity strategy?</h2>
          <p className="font-neuethin text-xl mb-8">Join thousands of traders who have already increased their yields with Lumos.</p>
